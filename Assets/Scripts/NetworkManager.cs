...
public class NetworkManager : NetworkBehaviour {
    private const string Address = "https://raw.githubusercontent.com/OpenHogwarts/hogwarts/master/latest_build.txt";
    ...
    public static void validateGameVersion ()
    {
        ...
        string latestVersion = (new WebClient()).DownloadString(Address).Trim();
